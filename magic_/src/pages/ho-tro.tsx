      ...
      <ContactPageStyled>
        <div className="container">
          <div className="content">
            <p>
              <i>
                Với mong muốn đem đến cho khách hàng sự yên tâm và những trải
                nghiệm tuyệt vời nhất khi sử dụng dịch vụ chuyển phát. Magic
                Post luôn không ngừng thay đổi để ngày càng đáp ứng sự mong đợi
                của Khách hàng.
              </i>
            </p>
          </div>
